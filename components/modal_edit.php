	...
	<?php
		...
		while($prestation_modif = mysqli_fetch_assoc($resultat_modif)) {
			...
			$prestation_modif_prix = $prestation_modif['prix'];
				...
				echo "<label for=\"edit_presta_desc\" name=\"edit_presta_desc\">Description : </label><br><textarea name=\"edit_presta_desc\" id=\"edit_presta_desc\">".$prestation_modif_desc."</textarea><br>";
